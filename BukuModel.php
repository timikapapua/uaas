...
class BukuModel {
	...
	{
		$query = "INSERT INTO buku (nama barang, penerbit, pengarang, tahun, kategori_id, harga) VALUES(:judul, :penerbit, :pengarang, :tahun, :kategori_id, :harga)";
		$this->db->query($query);
		$this->db->bind('nama barang', $data['nama barang']);
